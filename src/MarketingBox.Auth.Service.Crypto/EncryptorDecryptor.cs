...
namespace MarketingBox.Auth.Service.Crypto
{
    public static class EncryptorDecryptor
    {
        ...
        public static string Encrypt(this string src, byte[] initKey, byte[] initVector)
        {
        ...
        public static string Decrypt(this string encryptedText, byte[] initKey, byte[] initVector)
        {
